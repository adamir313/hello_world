...
import 'package:hello_world/models/auth.dart';
...
mixin ProductsModel on ConnectedProductsModel {
  ...
  Future<Map<String, dynamic>> uploadImage(File image,
    ...
    final imageUploadRequest = http.MultipartRequest(
        'POST',
        Uri.parse(
            'https://us-central1-flutter-products-df1f4.cloudfunctions.net/storeImage'));
  ...
  Future<bool> addProduct(String title, String description, File image,
    ...
    try {
      final http.Response response = await http.post(
          'https://flutter-products-df1f4.firebaseio.com/products.json?auth=${_authenticatedUser.token}',
  ...
  Future<bool> updateProduct(String title, String description, File image,
    ...
    try {
       await http.put(
          'https://flutter-products-df1f4.firebaseio.com/products/${selectedProduct.id}.json?auth=${_authenticatedUser.token}',
  ...
  Future<bool> deleteProduct() {
    ...
    return http
        .delete(
            'https://flutter-products-df1f4.firebaseio.com/products/$deletedProductId.json?auth=${_authenticatedUser.token}')
  ...
  void toggleProductFavoriteStatus(Product toggledProduct) async {
    ...
    if (newFavoriteStatus) {
      response = await http.put(
          'https://flutter-products-df1f4.firebaseio.com/products/${toggledProduct.id}/wishlistUsers/${_authenticatedUser.id}.json?auth=${_authenticatedUser.token}',
